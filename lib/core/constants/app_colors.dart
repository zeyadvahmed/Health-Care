...
class AppColors {
  ...
  static const Color steelColor = Color(
    0xFF137FEC,
  ); // "Steel" text + accent blue
  ...
  static const Color xpBackground = Color(
    0xFFFFF8E1,
  ); // warm tint behind XP card
